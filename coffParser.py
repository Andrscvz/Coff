...
class coffParser ( Parser ):
    ...
    llamarfunmetIdClaseActual = None #Para saber el objeto que tiene el metodo que se va a llamar
    ...
    def checkIfCountParametersMatch(self):
        ...
        if self.funcionOmetodo == 1: #funcion
            ...
            self.metodoTof = 1
            if self.nComas != len(self.dirProcs[   self.idFuncionActual, self.idDeMetodo(self.idFuncionActual)][2]):
        ...
        try:
            ...
            if token in [coffParser.CTEENT, coffParser.CTEDEC, coffParser.CTETEXTO]:
                ...
                if (self.ejecToken, self.scopeProcs) in self.tablaVariables:
                    ...
                    #self.insertarVariableEnMemoria(self.ejecToken)
    ...
    def llamarfunmet(self):
        ...
        try:
            ...
            self.llamarfunmetIdClaseActual = str(self.getCurrentToken().text)
            self.ejecToken = str(self.getCurrentToken().text)
        ...
        try:
            ...
            if token in [coffParser.PIZQ, coffParser.SUMA, coffParser.RESTA, coffParser.ID, coffParser.CTEENT, coffParser.CTEDEC, coffParser.CTETEXTO]:
                ...
                if self.llamarfunmetTof:
                    self.checaTipoExpresionConParametro(self.llamarfunmetIdClaseActual,self.idFuncionActual)
                else:
